    ...
    <>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto">
          ...
          <div className="flex flex-col items-center lg:mt-[12px] mt-[8px] -mx-2 mb-8">
            <Image className="object-cover lg:w-32 lg:h-32 w-24 h-24 mx-2 rounded-full" src={NewImage} alt="avatar"  width={200} height={100}/>
