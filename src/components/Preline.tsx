...
//               <Image
//                 className="object-cover lg:w-48 lg:h-48 w-24 h-24 mx-2 rounded-full"
//                 src={NewImage}
//                 alt="avatar"
//                 width={200}
//                 height={100}
//               />
//               <h4 className="mx-2 sm:ml-4 mt-2 font-medium text-indigo-400 dark:text-gray-200">
//                 Toheeb Olawale RAJI
//               </h4>
//               <p className="mx-2 mt-2 text-sm font-medium text-gray-300 dark:text-gray-400">
//                 Front End Developer
//               </p>
//             </div>
//             <Link
//               className="flex text-gray-500 py-2.5 px-4 my-4 rounded transition duration-200 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-cyan-500 hover:text-white"
//               href="/"
//             >
//               <svg
...
//               </div>
//             </div>
//             <p className="mb-1 px-5 py-3 mt-8 lg:mt-2 text-left text-xs text-cyan-500">
...
//       {/* Main content */}
//       <div
//         className={`p-4 ${isSidebarOpen ? 'sm:ml-0' : 'sm:ml-64'} lg:h-full md:h-full`}
//       >
//         <About />
