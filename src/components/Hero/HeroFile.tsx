    ...
    <>
      ...
      <div className="-mr-2 flex md:hidden">
          ...
          {({ open }) => (
            <>
            {/* <Sidebar/> */}
                    <Disclosure.Button  onClick={handleToggleSidebar} className="relative  items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
      ...
      {/* Main content */}
      <div
        className={`p-4 ${isSidebarOpen ? 'sm:ml-0' : 'sm:ml-64'} lg:h-[100vh] md:h-full sm:h-full`}
      >
     <aside
        ref={sidebarRef}
        id="default-sidebar"
