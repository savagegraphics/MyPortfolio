...
<div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
		...
		<div className="space-y-4">
			<details className="w-full border rounded-lg">
				...
				<p className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-400">The ability to analyze challenges and find creative, efficient solutions for both technical and design issues.</p>
			</details>
			<details className="w-full border rounded-lg">
