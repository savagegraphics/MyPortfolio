...
import { SiTailwindcss, SiRedux,SiWebpack} from 'react-icons/si';
...
const Index: React.FC = () => {
  return (
    ...
    <h5 className="mb-3 text-base font-semibold text-gray-900 md:text-xl dark:text-white">
     Frontend Fusion
      ...
      <p className="text-sm font-normal text-gray-500 dark:text-gray-400">Merging creativity, code, and user-centric design to craft seamless, captivating digital experiences.</p>
      <ul className="my-4 space-y-3">
        <li>
          <a href="#" className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-800 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-8000 dark:text-white">
          <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512">
            <path d="M0 32l34.9 395.8L191.5 480l157.6-52.2L384 32H0zm308.2 127.9H124.4l4.1 49.4h175.6l-13.6 148.4-97.9 27v.3h-1.1l-98.7-27.3-6-75.8h47.7L138 320l53.5 14.5 53.7-14.5 6-62.2H84.3L71.5 112.2h241.1l-4.4 47.7z"/>
          </svg>
            <span className="flex-1 ml-3 whitespace-nowrap">HTML</span>
            <span className="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-gray-600 rounded dark:bg-gray-700 dark:text-gray-400">Proficient</span>
          </a>
        </li>
        <li>
          <a href="#" className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-800 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-8000 dark:text-white">
          <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
            ...
            <span className="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-gray-600 rounded dark:bg-gray-700 dark:text-gray-400">Skilled</span>
 </a>
        </li>
        <li>
          <a href="#" className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-800 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-8000 dark:text-white">
  ...
  <path d="M333.5,201.4c0-22.1-15.6-34.3-43-34.3h-50.4v71.2h42.5C315.4,238.2,333.5,225,333.5,201.4z M517,188.6 c-9.5-30.9-10.9-68.8-9.8-98.1c1.1-30.5-22.7-58.5-54.7-58.5H123.7c-32.1,0-55.8,28.1-54.7,58.5c1,29.3-0.3,67.2-9.8,98.1 c-9.6,31-25.7,50.6-52.2,53.1v28.5c26.4,2.5,42.6,22.1,52.2,53.1c9.5,30.9,10.9,68.8,9.8,98.1c-1.1,30.5,22.7,58.5,54.7,58.5h328.7 c32.1,0,55.8-28.1,54.7-58.5c-1-29.3,0.3-67.2,9.8-98.1c9.6-31,25.7-50.6,52.1-53.1v-28.5C542.7,239.2,526.5,219.6,517,188.6z M300.2,375.1h-97.9V136.8h97.4c43.3,0,71.7,23.4,71.7,59.4c0,25.3-19.1,47.9-43.5,51.8v1.3c33.2,3.6,55.5,26.6,55.5,58.3 C383.4,349.7,352.1,375.1,300.2,375.1z M290.2,266.4h-50.1v78.4h52.3c34.2,0,52.3-13.7,52.3-39.5 C344.7,279.6,326.1,266.4,290.2,266.4z"/>
            ...
            <span className="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-gray-600 rounded dark:bg-gray-700 dark:text-gray-400">Advanced</span>
 </a>
        </li>
        <li>
          <a href="#" className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-800 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-8000 dark:text-white">
        ...
        <li>
          ...
          <SiRedux className='w-12 h-6'/>
            ...
            <span className="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-gray-600 rounded dark:bg-gray-700 dark:text-gray-400">Intermediate</span>
 </a>
        </li>
