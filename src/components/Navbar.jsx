                ...
                <div className="container mx-auto flex flex-wrap items-center justify-between">
                    ...
                    <div className="hidden md:block w-full md:w-auto" id="mobile-menu">
                        <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                            ...
                            <li>
                                ...
                                <div id="dropdownNavbar" className="hidden bg-white text-base z-10 list-none divide-y divide-gray-100 rounded shadow my-4 w-44">
                                    <ul className="py-1" aria-labelledby="dropdownLargeButton">
                                        <li>
                                            <Link href="#" className="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Dashboard</Link>
                                        </li>
                                        <li>
                                            <Link href="#" className="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Settings</Link>
                                        </li>
                                        <li>
                                            <Link href="#" className="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Earnings</Link>
                                        </li>
                                    </ul>
                                    <div className="py-1">
                                        <Link href="#" className="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Sign out</Link>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <Link href="#" className="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Services</Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href="#" className="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Contact</Link>
                            </li>
                        </ul>
                    </div>
                </div>
