...
const Review = () => {
  return (
    ...
    <div className="relative grid gap-5 sm:grid-cols-2 grid-cols-2-sm md:grid-cols-3 grid-cols-3-md lg:grid-cols-4 grid-cols-4-lg px-8">
		...
		<div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
			...
			<div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-violet-400 text-gray-900">
				<img src="https://source.unsplash.com/50x50/?portrait?4" alt="" className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full bg-gray-500" />
				<p className="text-xl font-semibold leadi">Distinctio Animi</p>
				<p className="text-sm uppercase">Aliquam illum</p>
			</div>
		</div>
