...
const DfHero = () => {
  return (
    ...
    <div className="grid gap-8 row-gap-10 ml-8 sm:grid-cols-2 grid-cols-2-sm md:grid-cols-3 grid-cols-3-md lg:grid-cols-4 grid-cols-4-lg">
      <div>
        ...
        <ul className="mb-4 -ml-1 space-y-2">
          <li className="flex items-start text-gray-200">
            <span className="mr-1">
              <svg
                className="w-5 h-5 mt-px text-gray-300"
                stroke="currentColor"
                viewBox="0 0 52 52"
              >
                <polygon
          ...
          <li className="flex items-start text-gray-300">
            <span className="mr-1">
              <svg
                className="w-5 h-5 mt-px text-gray-200"
                stroke="currentColor"
                viewBox="0 0 52 52"
              >
                <polygon
      ...
      <div>
        ...
        <ul className="mb-4 -ml-1 space-y-2">
          <li className="flex items-start text-gray-200">
            <span className="mr-1">
              <svg
                className="w-5 h-5 mt-px text-deep-gray-300"
                stroke="currentColor"
                viewBox="0 0 52 52"
              >
                <polygon
      ...
      <div>
        ...
        <h6 className="mb-2 font-semibold leading-5 text-white">Explore space</h6>
        <p className="mb-3 text-sm text-gray-300">
      ...
      <div>
        ...
        <h6 className="mb-2 font-semibold leading-5 text-white">First contact</h6>
        <p className="mb-3 text-sm text-gray-300">
