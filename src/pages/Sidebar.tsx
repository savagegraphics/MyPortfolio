...
const Navbar = () => {
  return (
      <div className="z-20 flex shrink-0 grow-0 justify-around gap-4 border-t border-gray-200 bg-white/50 p-2.5 shadow-lg backdrop-blur-lg dark:border-slate-600/60 dark:bg-slate-800/50 fixed top-3/4 -translate-y-1/4 right-6 min-h-[auto] min-w-[64px] flex-col rounded-lg border">
        <Link
          href="/AboutUs/About"
          className="my-button flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 bg-indigo-50 text-indigo-600 dark:bg-sky-900 dark:text-sky-50"
        >
